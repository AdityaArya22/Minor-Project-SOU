...
const Navbar = () => {
    return (
        <div className='bg-gradient-to-r from-[#859DBD] to-[#7e92e3] py-2 px-5 flex items-center justify-between'>
            ...
            <div className="links flex gap-10 text-xl">
                ...
                <div className='hover:text-white text-gray-200 transition-colors cursor-pointer'>
                    Home
                </div>
                <div className='hover:text-white text-gray-200 transition-colors cursor-pointer'>
                    Symptoms
